...
#import "HXRProtocolManager.h"

@interface HXRProtocolManager ()

@property (nonatomic, strong) NSMutableDictionary *serviceProvideSource;
@end

@implementation HXRProtocolManager

+ (HXRProtocolManager *)sharedInstance
{
    static HXRProtocolManager * instance;
